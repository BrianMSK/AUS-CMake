 ...
 */
template <class List> class ListAnalyzer : public ComplexityAnalyzer<List> {
protected:
 ...
 */
template <class List> class ListInsertAnalyzer : public ListAnalyzer<List> {
public:
 ...
 */
template <class List> class ListRemoveAnalyzer : public ListAnalyzer<List> {
public:
...
template <class List> int ListAnalyzer<List>::getRandomData() const {
  return data_;
}
...
inline ListsAnalyzer::ListsAnalyzer() : CompositeAnalyzer("Lists") {
  this->addAnalyzer(
      std::make_unique<ListInsertAnalyzer<std::vector<int>>>("vector-insert"));
  this->addAnalyzer(
      std::make_unique<ListInsertAnalyzer<std::list<int>>>("list-insert"));
  this->addAnalyzer(
      std::make_unique<ListRemoveAnalyzer<std::vector<int>>>("vector-remove"));
  this->addAnalyzer(
      std::make_unique<ListRemoveAnalyzer<std::list<int>>>("list-remove"));
}
} // namespace ds::utils
